  ...
  const projects = [
    {
      ...
      client: "Cencosud",
      tags: ["PHP", "Ionic", "JavaScript", "WhatsApp", "Integraciones", "API", "Desarrollo web", "MySQL"],
    },
    {
      id: "careband",
      title: "Careband",
    ...
    },
    {
      ...
      client: "Minera",
      tags: ["NestJS", "TypeScript", "TypeORM", "Desarrollo web", "Integraciones", "API", "PostgreSQL", "ReactJS"],
    },
    {
      id: "alpha-cronos",
      title: "Alpha Cronos",
      ...
      tags: ["PHP", "JavaScript", "MySQL", "Desarrollo web", "Integraciones", "API"],
    },
    {
      id: "axeon",
      title: "Axeon",
      ...
      tags: ["PHP", "JavaScript", "Bootstrap", "JQuery", "MySQL", "Desarrollo web", "Integraciones", "API"],
    },
    {
      id: "maket-me",
      title: "Maket Me",
      ...
      client: "Persona natural",
      tags: ["Node.js", "ReactJS", "TypeScript", "Ionic", "API", "Desarrollo web", "Desarrollo móvil", "Integraciones"],
    },
    {
      id: "non-stop",
      title: "Non-stop",
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl/relaxed">
                  Descubre algunos de los proyectos que hemos desarrollado para nuestros clientes, transformando sus
                  ideas en soluciones tecnológicas de alto impacto.
                </p>
              </div>
            </div>
